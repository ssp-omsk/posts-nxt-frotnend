        ...
        <div>
          ...
          >
            <button
              ...
              className="relative pl-4 pr-4 inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
            >
              &laquo;
            </button>
            <button
              ...
              disabled={currentPage === 1 ? true : false}
              className="relative pl-4 pr-4 inline-flex items-center px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
            >
            ...
            {pages.map((page) => {
              return (
                <button
                  ...
                  className={
                    page === currentPage
                      ? `relative z-10 inline-flex items-center px-4 font-bold text-md rounded-md bg-primary-focus text-white
               py-2 focus:z-20 focus-visible:outline ring-2 ring-primary
            ...
            <button
              ...
              disabled={
                currentPage === Math.ceil(totalCount / pageLimit) ? true : false
              }
              className="relative pl-4 pr-4 inline-flex items-center px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
            >
              &rsaquo;
